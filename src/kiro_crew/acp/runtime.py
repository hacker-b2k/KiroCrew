...
from kiro_crew.acp.mcp_session_report import active_custom_agent, required_managed_servers
...
class AcpRuntime:
    ...
    async def _wait_managed_mcp(
        ...
        try:
            ...
            # No handle escapes on failure. Unregister without invoking KAS's
            # destructive session/delete: a slow resume must retain its history.
