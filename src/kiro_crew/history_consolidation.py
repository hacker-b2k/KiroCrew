...
class HistoryConsolidator:
    ...
    async def _consolidate(
        ...
        pass returns ``None``. A changed source or unreadable privacy header
        remains pending without consuming the failure/abandon budget.
        """
        ...
        try:
            ...
            if privacy is _TranscriptPrivacy.PRIVATE:
                self._logger.info("consolidation skipped for %s: private transcript", key)
                return None
