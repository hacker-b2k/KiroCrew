      ...
      <div className="min-w-0 flex items-center gap-1.5">
        {editing ? (
          ...
          <div className="min-w-0 truncate">
            ...
            {showId && (
              <span className="ml-1.5 rounded border border-border bg-bg-elevated px-1 font-mono text-[11px] font-normal text-muted align-middle" title={t('pages.membersPage.member_id')} aria-label={`${t('pages.membersPage.member_id')}: ${member.name}`} data-testid="member-header-id">{member.name}</span>
            )}
