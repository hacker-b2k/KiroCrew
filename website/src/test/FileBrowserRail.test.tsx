...
describe('FileBrowserRail content results', () => {
  ...
  it('opens a PDF hit from the start, like every other document hit', async () => {
    H.fileGrep.mockResolvedValue({
      ...GREP_PAYLOAD,
    ...
    // Jumping a PDF hit to its page is out of scope, so `p 3` is a label and
    ...
    expect(onFileOpen).toHaveBeenCalledWith('/repo/docs/spec.pdf', false, undefined)
