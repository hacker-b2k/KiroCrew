...
/* A realistic legacy record: the two states a crew most often had a chime
   on, so the notice photographs with real state names in it. */
const retiredCue: ('working' | 'done' | 'error')[] =
  params.get('retiredCue') === '1' ? ['done', 'error'] : []
